...
public class WechatServiceImpl implements WechatService {
    ...
    private static final String APP_ID="wx7496307a795a17e3";
    private static final String APP_SECRET="b09495b2117ee919178380de5f2aa66c";
    private static final String SCOPE = "snsapi_userinfo";//  snsapi_userinfo  snsapi_base

    private String pcCallbackUrl = "https://7d2fe8a0.r11.cpolar.top/wechat/pcAuth"; //pc回调域名

    private String mobileCallbackUrl = "https://7d2fe8a0.r11.cpolar.top/wechat/mobileAuth"; //mobile回调域名
